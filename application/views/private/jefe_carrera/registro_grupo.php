...
<form class="form-horizontal" id="addGrupo" action="<?php echo base_url(); ?>jefe_carrera/add_grupo" method="post">
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <input type="text" class="form-control" name="id_grupo" maxlength="13" placeholder="Escriba el Id del Grupo" value="<?php if(isset($id_grupo)){echo $id_grupo;} ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="nombre" class="col-sm-3 control-label">Nombre Grupo </label>
        <div class="col-sm-6">
            <input type="text" class="form-control" name="nombre" maxlength="50" placeholder="Escriba el Nombre de Salón" value="<?php if(isset($nombre)){echo $nombre;} ?>">
        </div>
    </div>
    <div class="form-group">
