...
<form id="formRegJefeCarrera" class="form-horizontal" action="<?php echo base_url(); ?>administrador/edit_catedratico/<?php echo $id_usuario; ?>" method="post">
    <div class="form-group">
        <label for="id_usuario" class="col-sm-3 control-label">Id Catedrático</label>
        <div class="col-sm-6">
            <input type="text" class="form-control" readonly="" name="id_usuario" maxlength="5" placeholder="Escriba el Id del Catedrático" value="<?php if(isset($id_usuario)){ echo $id_usuario; } ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <input type="text" class="form-control" name="nombre" maxlength="40" placeholder="Escriba el Nombre del Catedrático" value="<?php if(isset($nombre)){ echo $nombre; } ?>">
        </div>
    </div>
