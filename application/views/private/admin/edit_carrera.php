...
<form class="form-horizontal" id="addCarrera" action="<?php echo base_url(); ?>administrador/edit_carrera/<?php echo $id_carrera; ?>" method="post">
    <div class="form-group">
        <label for="id_carrera" class="col-sm-3 control-label">Id Carrera</label>
        <div class="col-sm-6">
            <input type="text" class="form-control" name="id_carrera" readonly="" value="<?php if(isset($id_carrera)){echo $id_carrera;} ?>">
        </div>
    </div>
    <div class="form-group">
