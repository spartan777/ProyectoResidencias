...
<form class="form-horizontal" id="addClasificacion" action="<?php echo base_url(); ?>administrador/add_clasificacion" method="post">
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <input type="text" class="form-control" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" name="id_clasificacion" maxlength="2" placeholder="Escriba el Id Clasificación" value="<?php if(isset($id_clasificacion)){echo $id_clasificacion;} ?>">
        </div>
    </div>
    <div class="form-group">
